...
class _MainScreen extends State<MainScreen> with WidgetsBindingObserver {
  ...
  void getData(String selectedRoom, List rooms) async {
    ...
    if (selectedRoom != '') {
      ...
      selectedRoom = selectedIndex > -1 && roomSigned[selectedIndex]['status']
            ...
            children: [
              SizedBox(
                  ...
                  child: Stack(children: [
                    SizedBox(
                      ...
                      height: 106,
                      child: totalRooms[selectRoomNumber]['channel']['image'] !=
                              null
                          ? Image.network(
              ...
              Expanded(
                  child: SingleChildScrollView(
                    ...
                    channelSegment('assets/images/main-user-comunity.svg',
                        'ユーザーコミュニティ', 3),
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    const AddFeedPage(postType: 'tweet')),
                          );
                        },
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    const AddFeedPage(postType: 'diary')),
                          );
                        },
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,

...
class _AlertPage extends State<AlertPage> {
  ...
  final _pageSize = 5;
  final Uri _alertHelp = Uri.parse(
      'https://wivil.notion.site/wivil/5d2880c3f3a84cde9b1e98cd7bd1be24');
                            ...
                            ListTile(
                              ...
                              trailing: Container(
                                ...
                                child: InkWell(
                                    ...
                                    child: Text(
                                      activity.object['message'] != null
                                          ? activity.object['message']
                                              .toString()
                                          : activity.object['text'].toString(),
  ...
  void _openHelp() async {
    if (!await launchUrl(
      ...
      throw Exception('Could not launch $_alertHelp');
    }
  }
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      ...
      final feed =
          feedClient.notificationFeed('notification_alert', currentUser);

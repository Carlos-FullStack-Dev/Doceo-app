...
class Tag extends amplify_core.Model {
  ...
  const Tag._internal({required this.id, required name, users, feedsCount, category, createdAt, updatedAt}): _name = name, _users = users, _feedsCount = feedsCount, _category = category, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Tag({String? id, required String name, List<UserTag>? users, int? feedsCount, Category? category}) {
    return Tag._internal(
      id: id == null ? amplify_core.UUID.getUUID() : id,
      name: name,
      users: users != null ? List<UserTag>.unmodifiable(users) : users,
  ...
  Tag copyWith({String? name, List<UserTag>? users, int? feedsCount, Category? category}) {
    return Tag._internal(
      id: id,
      name: name ?? this.name,
  ...
  Tag copyWithModelFieldValues({
    ...
    ModelFieldValue<List<UserTag>?>? users,
    ...
    : id = json['id'],
      ...
      _users = json['users'] is List
        ? (json['users'] as List)
          ...
          .map((e) => UserTag.fromJson(new Map<String, dynamic>.from(e['serializedData'])))
          .toList()
        : null,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'users': _users?.map((UserTag? e) => e?.toJson()).toList(), 'feedsCount': _feedsCount, 'category': _category?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final USERS = amplify_core.QueryField(
    fieldName: "users",
    fieldType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.model, ofModelName: 'UserTag'));
  static final FEEDSCOUNT = amplify_core.QueryField(fieldName: "feedsCount");

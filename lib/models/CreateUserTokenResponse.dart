...
class CreateUserTokenResponse {
  ...
  CreateUserTokenResponse copyWithModelFieldValues({
    ModelFieldValue<String>? token,
    ModelFieldValue<List<ChannelDetail>?>? rooms
  }) {
    return CreateUserTokenResponse._internal(
      token: token == null ? this.token : token.value,
      rooms: rooms == null ? this.rooms : rooms.value
    );
  }
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.embedded(
      ...
      isRequired: true,
      isArray: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.embeddedCollection, ofCustomTypeName: 'ChannelDetail')
    ));
  });
}
...
class ChannelDetail {
  ...
  ChannelDetail copyWithModelFieldValues({
    ModelFieldValue<Channel>? channel,
    ModelFieldValue<List<Member>?>? members,
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.embedded(
      fieldName: 'channel',
      isRequired: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.embedded, ofCustomTypeName: 'Channel')
    ));
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.embedded(
      ...
      isRequired: true,
      isArray: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.embeddedCollection, ofCustomTypeName: 'Member')
    ));
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.embedded(
      ...
      isRequired: true,
      isArray: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.embeddedCollection, ofCustomTypeName: 'Message')
    ));
  });
}